...
import { Button, Col, Container, Modal, ModalBody, ModalHeader, Progress, Row, Spinner } from 'reactstrap';
...
export default function ProductDetail() {
  ...
  return (
    <div>
      ...
      <br />
      <br />
      <Progress color="success" value={progress} style={{ height: "2px" }} />
      {
        spinner && (
          <>
            <Container className='text-center'>
              <Spinner color="primary" style={{ height: '5rem', width: '5rem', position: "fixed", top: "320px" }} >
                Loading...
              </Spinner>
            </Container>
          </>
        ...
        !spinner && (
          <>
            ...
            <div style={{ margin: "15px" }}>
              <SimilarProduct id={location.state.id} />
            </div>
          </>)
      }
    </div>
